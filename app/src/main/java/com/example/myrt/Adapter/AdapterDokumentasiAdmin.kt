package com.example.myrt.Adapter
...
import com.example.myrt.Admin.KegiatanDetailActivity
import com.squareup.picasso.Picasso

class AdapterDokumentasiAdmin(val dataAlbum: List<HashMap<String,String>>, val parent: KegiatanDetailActivity) :
    RecyclerView.Adapter<AdapterDokumentasiAdmin.HolderDataAlbum>(){
                    ...
                    R.id.context_hapus -> {
                        AlertDialog.Builder(v.context)
                            ...
                            .setPositiveButton("Ya", DialogInterface.OnClickListener { dialogInterface, i ->
                                parent.deleteDokumentasi(data.get("kd_dokumentasi").toString())
                            })
